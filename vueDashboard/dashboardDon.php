...
include ('../actions/admin/donCrud/adminDonList.php');
logged_only();
?>
<!DOCTYPE html>
<html lang="fr">
...
<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="dashboardDonation.php">
...
<main id="main" class="main">
    ...
    <div class="text-end">
        <a href="don/dashCreateDon.php" class="btn btn-primary"><i class="bi
        bi-person-plus"></i> Créer un don</a>
    </div>
            ...
            <table class="table table-striped table-hover">
                ...
                <?php foreach($dons as $don):?>
                    <tr>
                        <td><?= $don->iddon; ?></td>
                        <td><?= $don->Title; ?></td>
                        <td><?= $don->categories; ?></td>
                        <td>
                            <a href="don/dashEditDon.php?id=<?=$don->iddon ?>" class="edit"
